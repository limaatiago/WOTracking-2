...
<div id="blocos-conteudo">
	<table id="bloco-status" style="border-bottom: 20px solid #efc415; margin-right: 3%;">
		...
		<input type="hidden" name="dias_serv" value="<?php echo $os_info->dias_serv ?>" />
		<tbody>
			<tr>
...
<div id="blocos-conteudo">
	...
	<table id="bloco-status" style="border-bottom: 20px solid #eb5c4c; margin-right: 3%;">
		...
		<tbody>
			<tr>
				<td id="primeiro-botao">
					Técnico responsável:<br/><input type="text" name="tecnico_resp" required />
				</td>
			</tr>
			<tr>
				<td>
...
<div id="blocos-conteudo">
	...
	<table id="bloco-status" style="border-bottom: 20px solid #0dbc9d;">
		...
		<tbody>
			<tr>
				<td id="primeiro-botao">
				<input type="submit" name="entregue_rep_cli" class="button" value="Sim" />
				</td>
			</tr>
			<tr>
				<td id="ultimo-botao">
...
<div id="blocos-conteudo">
	...
	<table id="bloco-status" class="quadro-esconder" style="border-bottom: 20px solid #d6d5d1; margin-right: 3%;">
		...
		<tbody>
			<tr>
				<td id="um-botao">
				<input type="submit" class="button" value="Sim, por <?php echo $os_info->tecnico_resp; ?>" disabled />
				</td>
			</tr>
		</tbody>
	</table>
...
<div id="blocos-conteudo">
	...
	<table id="bloco-status" style="border-bottom: 20px solid #0dbc9d;">
		...
		<tbody>
			<tr>
				<td id="primeiro-botao">
				<input type="submit" name="entregue_rep_tec" class="button" value="Sim"/>
				</td>
			</tr>
			<tr>
				<td id="ultimo-botao">
