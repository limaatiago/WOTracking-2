...
$prazo_orcamento	=	$_POST['prazo-orc'];
...
update_option( 'wot_prazo_orc', $prazo_orcamento );
		...
		<form name="form-config-empresa" method="post" >
			<table id="wot_tabela" class="widefat">
				...
				<tbody>
					...
					<tr>
						<td>
							<label for="prazo-orc"><b>Prazo de orçamento</b></label> <br />
							<input name="prazo-orc" type="text" id="prazo-orc" value="<?php echo get_option( 'wot_prazo_orc' ) ?>" />
						</td>
						<td>
						</td>
					</tr>
