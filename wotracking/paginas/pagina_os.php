...
global $wpdb, $tabela_os, $tabela_empresa, $tabela_orcamento, $tabela_clientes;
...
if ( $os_info ) {
	...
	<div class="wrap">			
		<h2>
			...
			<a href="<?php echo admin_url("admin.php?page=" . $pagina_atual . "&num=" . $num_os . "&imprimir=os")?>"><input type="button" name="imprimir_os" id="btn-imprimir" class="button button-primary" value="Imprimir OS"/></a>
			<?php if ( $os_info->status_os > 1 ) {
			?>
			<a href="<?php echo admin_url("admin.php?page=" . $pagina_atual. "&num=" . $num_os . "&imprimir=orcamento")?>"><input type="button" name="imprimir_orc" id="btn-imprimir" class="button button-primary" value="Imprimir Orçamento"/></a>
			<?php } ?>
		</h2> 
		<div id="conteudo">
	...
	elseif ( $os_info->status_os == 8 || $os_info->status_os == 9 || $os_info->status_os == 10 ) {
...
else { echo "<h2>OS Não Localizada</h2>"; }
	?>